-- This is simply modified version of main branch's query, which is not written by me.
-- Query Set 1
SELECT
    d.year,
    d.month,
...
SELECT
    ...
    (monthly_profit - LAG(monthly_profit) OVER (ORDER BY year, month)) AS mom_change
FROM monthly
ORDER BY year, month;